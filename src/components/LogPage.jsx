        ...
        <div className="w-full  rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 bg-gray-800 border-solid border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
                ...
                <div className="flex items-start">
                  <div className="flex items-center h-5">
                    <input
                      ...
                      type="checkbox"
                      className="w-4 h-4  bg-gray-700 border-gray-600 focus:ring-primary-600 ring-offset-gray-800"
                      required
                    />
                  </div>
              ...
              <button
                type="submit"
                className="w-full text-white  font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-primary-600 hover:bg-primary-700 focus:ring-primary-800"
              >
                Sign in
              </button>
            </form>
